...
public class CircleImageViewThree extends ImageView {
    ...
    public CircleImageViewThree(Context context) {
        this(context, null);
    }

    public CircleImageViewThree(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleImageViewThree, 0, 0);

            strokeColor = a.getColor(R.styleable.CircleImageViewThree_strokeColor, Color.TRANSPARENT);
            strokeWidth = a.getDimensionPixelSize(R.styleable.CircleImageViewThree_strokeWidth, 0);
            highlightEnable = a.getBoolean(R.styleable.CircleImageViewThree_highlightEnable, true);
            highlightColor = a.getColor(R.styleable.CircleImageViewThree_highlightColor, DEF_PRESS_HIGHLIGHT_COLOR);
